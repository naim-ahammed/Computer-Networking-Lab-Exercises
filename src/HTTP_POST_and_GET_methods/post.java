package HTTP_POST_and_GET_methods;
...
public class post{
 public static void main(String[] args) throws MalformedURLException,
         ...
         // opening the connection to a URL webpage where we can post.post
         ...
         // this is to be done so that we can surely post.post anything using this connection
         ...
         // this is the string we wanted to post.post in the URL
         out.write(postedString.getBytes());
         // we write/post.post all the bytes in the string postedString
